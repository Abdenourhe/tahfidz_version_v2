// src/app/teacher/library/collections/[id]/contents/page.tsx
...
export default async function TeacherCollectionContentsPage({ params }: Params) {
  ...
  if (!collection) redirect("/teacher/library")
  ...
  if (!accessible) redirect("/teacher/library")
