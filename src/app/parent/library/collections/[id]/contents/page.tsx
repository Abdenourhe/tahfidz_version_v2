// src/app/parent/library/collections/[id]/contents/page.tsx
...
export default async function ParentCollectionContentsPage({ params }: Params) {
  ...
  if (!collection) redirect("/parent/library")
  ...
  if (!accessible) redirect("/parent/library")
