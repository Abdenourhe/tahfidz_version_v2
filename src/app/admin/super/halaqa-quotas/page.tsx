// src/app/admin/super/halaqa-quotas/page.tsx
// Gestion des écoles et quotas Halaqa — intégré au portail SuperAdmin.
...
export default async function HalaqaQuotasPage() {
