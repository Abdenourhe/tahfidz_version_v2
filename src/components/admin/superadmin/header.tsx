  ...
  return (
    <header className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 px-6 py-3.5 flex items-center justify-between sticky top-0 z-10 shadow-sm">
      <div className="flex items-center gap-3">
        ...
        <div><h1 className="font-bold text-gray-900 dark:text-gray-100">TAHFIDZ — Administration</h1><p className="text-xs text-gray-400 dark:text-gray-500">Tableau de bord plateforme</p></div>
      </div>
      <div className="flex items-center gap-3">
