...
import {
  LayoutDashboard, GraduationCap, Users, BookOpen, Settings, UserCircle,
} from "lucide-react"

const MOBILE_NAV = [
  { href: "/admin/dashboard", icon: LayoutDashboard, key: "dashboard" },
  { href: "/admin/students", icon: GraduationCap, key: "students" },
  { href: "/admin/teachers", icon: Users, key: "teachers" },
  { href: "/admin/groups", icon: BookOpen, key: "groups" },
  { href: "/admin/settings", icon: Settings, key: "settings" },
  { href: "/admin/profile", icon: UserCircle, key: "profile" },
]
