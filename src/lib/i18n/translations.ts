...
export const translations = {
  ...
  nav: {
    ...
    scanCard:       { fr: "Scan",              en: "Scan",             ar: "مسح" },
  ...
  studentForm: {
    ...
    noGroupAvailable:{ fr: "Aucun groupe disponible", en: "No group available", ar: "لا توجد مجموعات متاحة" },
    primary:         { fr: "principal", en: "primary", ar: "رئيسي" },
    groupsHint:      { fr: "Le premier groupe coché est le groupe principal.", en: "The first checked group is the primary group.", ar: "المجموعة المحددة الأولى هي المجموعة الرئيسية." },
  ...
  teachers_2: {
    ...
    maxTeachers:     { fr: "Max enseignants", en: "Max teachers", ar: "الحد الأقصى للمعلمين" },
    monthlyHalaqas:  { fr: "Halaqas/mois", en: "Halaqas/month", ar: "حلقات/شهر" },
    maxDuration:     { fr: "Durée max", en: "Max duration", ar: "المدة القصوى" },
    recordingAllowed:{ fr: "Enregistrement", en: "Recording", ar: "التسجيل" },
  ...
  attendanceXX: {
    ...
    subtitle:        { fr: "Consultez et exportez l'historique des présences de vos groupes.", en: "View and export attendance history for your groups.", ar: "عرض وتصدير سجل الحضور لمجموعاتك." },
    ...
    teacher:         { fr: "Enseignant", en: "Teacher", ar: "المعلم" },
    students:        { fr: "élèves", en: "students", ar: "طلاب" },
    fullName:        { fr: "Nom", en: "Name", ar: "الاسم" },
    fullNameAr:      { fr: "Nom arabe", en: "Arabic name", ar: "الاسم العربي" },
    downloadTitle:   { fr: "Télécharger", en: "Download", ar: "تحميل" },
    downloadOne:     { fr: "Exporter", en: "Export", ar: "تصدير" },
    downloadAll:     { fr: "Tous les groupes", en: "All groups", ar: "جميع المجموعات" },
    exportCsv:       { fr: "CSV", en: "CSV", ar: "CSV" },
    exportXlsx:      { fr: "Excel", en: "Excel", ar: "Excel" },
    exportPdf:       { fr: "PDF", en: "PDF", ar: "PDF" },
    exportThisGroup:     { fr: "ce groupe", en: "this group", ar: "هذه المجموعة" },
    exportAllGroups:     { fr: "tous les groupes", en: "all groups", ar: "جميع المجموعات" },
    exportThisGroupLabel:{ fr: "Exporter le groupe", en: "Export group", ar: "تصدير المجموعة" },
    exportAllGroupsLabel:{ fr: "Exporter tous les groupes", en: "Export all groups", ar: "تصدير جميع المجموعات" },
    switchToAllGroups:   { fr: "Passer à tous les groupes", en: "Switch to all groups", ar: "الانتقال إلى جميع المجموعات" },
    switchToFirstGroup:  { fr: "Choisir le premier groupe", en: "Choose first group", ar: "اختيار المجموعة الأولى" },
    generating:          { fr: "Génération…", en: "Generating…", ar: "جارٍ التوليد…" },
    ...
    statsTitle:      { fr: "Statistiques", en: "Statistics", ar: "الإحصائيات" },
    globalRate:      { fr: "Taux global", en: "Overall rate", ar: "المعدل العام" },
    totalPresent:    { fr: "Présences", en: "Present", ar: "الحضور" },
    totalAbsent:     { fr: "Absences", en: "Absent", ar: "الغياب" },
    totalLate:       { fr: "Retards", en: "Late", ar: "التأخر" },
    totalExcused:    { fr: "Excusés", en: "Excused", ar: "المعذورون" },
    ...
    successMsg:      { fr: "téléchargé", en: "downloaded", ar: "تم التحميل" },
  ...
  teacherDailyLog: {
    ...
    linkedAssignment:  { fr: "Assignation liée", en: "Linked assignment", ar: "المهمة المرتبطة" },
    noAssignment:      { fr: "Aucune assignation", en: "No assignment", ar: "لا توجد مهمة" },
    save:              { fr: "Enregistrer", en: "Save", ar: "حفظ" },
    saving:            { fr: "Enregistrement...", en: "Saving...", ar: "جارٍ الحفظ..." },
  ...
  teacherMemorizationPanel: {
    ...
    viewProfile:       { fr: "Voir le profil de", en: "View profile of", ar: "عرض ملف" },
    evaluate:          { fr: "Évaluer", en: "Evaluate", ar: "تقييم" },
    fillInDailyLog:    { fr: "Remplir dans le carnet", en: "Fill in daily log", ar: "تعبئة في السجل اليومي" },
    ...
    searchStudentOrSurah:{ fr: "Rechercher un élève ou une sourah...", en: "Search a student or Surah...", ar: "البحث عن طالب أو سورة..." },
    activeSurahs:      { fr: "Sourates actives", en: "Active Surahs", ar: "السور النشطة" },
    averageProgress:   { fr: "Progression moyenne du groupe", en: "Group average progress", ar: "متوسط تقدم المجموعة" },
    assignments:       { fr: "Assignations", en: "Assignments", ar: "التعيينات" },
    inProgress:        { fr: "En cours", en: "In progress", ar: "جارٍ" },
    memorized:         { fr: "Mémorisées", en: "Memorized", ar: "محفوظة" },
    average:           { fr: "moyenne", en: "average", ar: "متوسط" },
    seeMore:           { fr: "Voir plus", en: "See more", ar: "عرض المزيد" },
    seeLess:           { fr: "Voir moins", en: "See less", ar: "عرض أقل" },
    status_inProgress: { fr: "En cours", en: "In progress", ar: "جارٍ" },
    status_memorized:  { fr: "Mémorisé", en: "Memorized", ar: "محفوظ" },
    status_overdue:    { fr: "En retard", en: "Overdue", ar: "متأخر" },
    status_assigned:   { fr: "Assigné", en: "Assigned", ar: "معين" },
  },
  ...
  teacherSidebar: {
    ...
    library:      { fr: "Bibliothèque", en: "Library", ar: "المكتبة" },
    attendance:   { fr: "Présences", en: "Attendance", ar: "الحضور" },
    scanCard:     { fr: "Scanner carte", en: "Scan card", ar: "مسح البطاقة" },
    evaluations:  { fr: "Évaluations", en: "Evaluations", ar: "التقييمات" },
    announcements:{ fr: "Annonces", en: "Announcements", ar: "الإعلانات" },
    notifications:{ fr: "Notifications", en: "Notifications", ar: "الإشعارات" },
    profile:      { fr: "Mon profil", en: "My Profile", ar: "ملفي الشخصي" },
  ...
  superadmin: {
    ...
    planEconomique:    { fr: "Économique", en: "Economique", ar: "اقتصادي" },
    planPro:           { fr: "Pro", en: "Pro", ar: "احترافي" },
    planEnterprise:    { fr: "Entreprise", en: "Enterprise", ar: "مؤسسي" },
    planQuotas:        { fr: "Plan & quotas", en: "Plan & quotas", ar: "الخطة والحصص" },
    noPlanData:        { fr: "Données plan indisponibles", en: "Plan data unavailable", ar: "بيانات الخطة غير متوفرة" },
  ...
  // ─── Register School (src/app/register-school/RegisterSchoolClient.tsx) ─────────
  registerSchool: {
    // Success screen
    ...
    sessionDuration:    { fr: "Durée de séance :",                            en: "Session duration:",                      ar: "مدة الجلسة:" },
    minutes:            { fr: "min",                                          en: "min",                                    ar: "دقيقة" },
    // Steps
    stepSchool:         { fr: "École",                                        en: "School",                                 ar: "المدرسة" },
    stepAdmin:          { fr: "Administrateur",                               en: "Administrator",                          ar: "المدير" },
    stepCapacity:       { fr: "Capacité",                                     en: "Capacity",                               ar: "الطاقة" },
    stepIndicator:      { fr: "Étape {0} sur {1}",                            en: "Step {0} of {1}",                        ar: "الخطوة {0} من {1}" },
    // Step 1 — School
    schoolInfoTitle:    { fr: "Informations de l'école",                      en: "School information",                     ar: "معلومات المدرسة" },
    schoolNameLabel:    { fr: "Nom de l'école",                               en: "School name",                            ar: "اسم المدرسة" },
    schoolNamePlaceholder:{ fr: "Medersa Al-Nour",                            en: "Al-Nour Madrasa",                        ar: "مدرسة النور" },
    logoLabel:          { fr: "Logo de l'école",                              en: "School logo",                            ar: "شعار المدرسة" },
    optional:           { fr: "(optionnel)",                                  en: "(optional)",                             ar: "(اختياري)" },
    chooseLogo:         { fr: "Choisir un logo",                              en: "Choose a logo",                          ar: "اختر شعاراً" },
    remove:             { fr: "Retirer",                                      en: "Remove",                                 ar: "إزالة" },
    logoHint:           { fr: "PNG, JPG, WEBP ou SVG — Max 2 Mo",             en: "PNG, JPG, WEBP or SVG — Max 2 MB",       ar: "PNG أو JPG أو WEBP أو SVG — بحد أقصى 2 ميغابايت" },
    addressLabel:       { fr: "Adresse",                                      en: "Address",                                ar: "العنوان" },
    addressPlaceholder: { fr: "Rue, quartier, commune...",                    en: "Street, neighborhood, municipality...",  ar: "الشارع، الحي، البلدية..." },
    cityLabel:          { fr: "Ville",                                        en: "City",                                   ar: "المدينة" },
    cityPlaceholder:    { fr: "Alger",                                        en: "Algiers",                                ar: "الجزائر" },
    countryLabel:       { fr: "Pays",                                         en: "Country",                                ar: "الدولة" },
    countryDZ:          { fr: "Algérie",                                      en: "Algeria",                                ar: "الجزائر" },
    countryMA:          { fr: "Maroc",                                        en: "Morocco",                                ar: "المغرب" },
    countryTN:          { fr: "Tunisie",                                      en: "Tunisia",                                ar: "تونس" },
    countryFR:          { fr: "France",                                       en: "France",                                 ar: "فرنسا" },
    countryBE:          { fr: "Belgique",                                     en: "Belgium",                                ar: "بلجيكا" },
    countryCA:          { fr: "Canada",                                       en: "Canada",                                 ar: "كندا" },
    countrySA:          { fr: "Arabie Saoudite",                              en: "Saudi Arabia",                           ar: "المملكة العربية السعودية" },
    countryOther:       { fr: "Autre",                                        en: "Other",                                  ar: "أخرى" },
    // Step 2 — Admin
    adminTitle:         { fr: "Compte administrateur",                        en: "Administrator account",                  ar: "حساب المدير" },
    fullNameLabel:      { fr: "Nom complet",                                  en: "Full name",                              ar: "الاسم الكامل" },
    fullNamePlaceholder:{ fr: "Sheikh Mohammed Benali",                       en: "Sheikh Mohammed Benali",                 ar: "الشيخ محمد بنعلي" },
    emailLabel:         { fr: "Email",                                        en: "Email",                                  ar: "البريد الإلكتروني" },
    emailPlaceholder:   { fr: "directeur@ecole.com",                          en: "principal@school.com",                   ar: "مدير@مدرسة.com" },
    phoneLabel:         { fr: "Téléphone",                                    en: "Phone",                                  ar: "الهاتف" },
    phonePlaceholder:   { fr: "(+213) 6xx xxx xxxx",                         en: "(+213) 6xx xxx xxxx",                  ar: "(+213) 6xx xxx xxxx" },
    passwordLabel:      { fr: "Mot de passe",                                 en: "Password",                               ar: "كلمة المرور" },
    passwordPlaceholder:{ fr: "min. 8 caractères",                            en: "min. 8 characters",                      ar: "8 أحرف على الأقل" },
    confirmLabel:       { fr: "Confirmer",                                    en: "Confirm",                                ar: "تأكيد" },
    confirmPlaceholder: { fr: "répéter",                                      en: "repeat",                                 ar: "أعد الإدخال" },
    // Step 3 — Capacity
    capacityTitle:      { fr: "Capacité prévue",                              en: "Expected capacity",                      ar: "الطاقة المتوقعة" },
    classesLabel:       { fr: "Classes",                                      en: "Classes",                                ar: "الفصول" },
    classesPlaceholder: { fr: "5",                                            en: "5",                                      ar: "5" },
    studentsPerClassLabel:{ fr: "Élèves/classe",                              en: "Students/class",                         ar: "طلاب/فصل" },
    studentsPerClassPlaceholder:{ fr: "15",                                   en: "15",                                     ar: "15" },
    teachersLabel:      { fr: "Enseignants",                                  en: "Teachers",                               ar: "المعلمون" },
    ...
    // Capacity warning
    capacityExceeded:   { fr: "Capacité dépassée pour le plan",               en: "Capacity exceeded for the",              ar: "الطاقة المحددة تتجاوز حدود خطة" },
    maxStudentsExceeded:{ fr: "Le plan {plan} permet max {max} élèves, vous en avez estimé {count}.", en: "The {plan} plan allows max {max} students, you estimated {count}.", ar: "تسمح خطة {plan} بحد أقصى {max} طالباً، وأنت قدّرت {count}." },
    maxTeachersExceeded:{ fr: "Le plan {plan} permet max {max} enseignants, vous en avez indiqué {count}.", en: "The {plan} plan allows max {max} teachers, you indicated {count}.", ar: "تسمح خطة {plan} بحد أقصى {max} معلماً، وأنت أدخلت {count}." },
    recommendPlan:      { fr: "Nous vous recommandons le plan {plan} ou supérieur.", en: "We recommend the {plan} plan or higher.", ar: "نوصي بخطة {plan} أو أعلى." },
    chooseOffer:        { fr: "Choisir une offre adaptée",                    en: "Choose a suitable plan",                 ar: "اختر عرضاً مناسباً" },
    recommended:        { fr: "Recommandé",                                   en: "Recommended",                            ar: "موصى به" },
    unlimitedHalaqas:   { fr: "Halaqas illimitées",                           en: "Unlimited Halaqas",                      ar: "حلقات غير محدودة" },
    halaqasPerMonth:    { fr: "Halaqas/mois",                                 en: "Halaqas/month",                          ar: "حلقة/شهر" },
    maxDuration:        { fr: "min max",                                      en: "min max",                                ar: "دقيقة كحد أقصى" },
    selected:           { fr: "Sélectionné",                                  en: "Selected",                               ar: "مختارة" },
    // Errors
    passwordMismatch:   { fr: "Les mots de passe ne correspondent pas.",      en: "Passwords do not match.",                ar: "كلمتا المرور غير متطابقتين." },
    passwordMinLength:  { fr: "Le mot de passe doit contenir au moins 8 caractères.", en: "Password must contain at least 8 characters.", ar: "يجب أن تحتوي كلمة المرور على 8 أحرف على الأقل." },
    submitError:        { fr: "Erreur lors de la soumission.",                en: "Error during submission.",               ar: "حدث خطأ أثناء الإرسال." },
    networkError:       { fr: "Une erreur réseau est survenue.",              en: "A network error occurred.",              ar: "حدث خطأ في الشبكة." },
    logoSizeError:      { fr: "Le logo ne doit pas dépasser 2 Mo.",           en: "Logo must not exceed 2 MB.",             ar: "يجب ألا يتجاوز حجم الشعار 2 ميغابايت." },
    // Footer
    back:               { fr: "Retour",                                       en: "Back",                                   ar: "رجوع" },
    next:               { fr: "Suivant",                                      en: "Next",                                   ar: "التالي" },
    sending:            { fr: "Envoi…",                                       en: "Sending…",                               ar: "جارٍ الإرسال…" },
  ...
  teacherScan: {
    ...
    autoConfirm:      { fr: "Validation auto",                   en: "Auto-confirm",                 ar: "تأكيد تلقائي" },
    autoConfirmHint:  { fr: "Valider la présence dès le scan",   en: "Validate attendance immediately", ar: "تأكيد الحضور فور المسح" },
    continuousScan:   { fr: "Scan continu",                      en: "Continuous scan",              ar: "مسح مستمر" },
    continuousScanHint:{ fr: "Reprendre le scan après validation", en: "Resume scanning after validation", ar: "استئناف المسح بعد التحقق" },
    history:          { fr: "Historique",                        en: "History",                      ar: "السجل" },
    historyEmpty:     { fr: "Aucun scan aujourd'hui",            en: "No scans today",               ar: "لا توجد عمليات مسح اليوم" },
    resumeScan:       { fr: "Reprendre le scan",                 en: "Resume scanning",              ar: "استئناف المسح" },
    attendanceConfirmed:{ fr: "Présence validée",                en: "Attendance confirmed",         ar: "تم تأكيد الحضور" },
    scanAgain:        { fr: "Scanner à nouveau",                 en: "Scan again",                   ar: "مسح مرة أخرى" },
    ...
    alreadyPresent:   { fr: "Élève déjà présent",                en: "Student already present",      ar: "الطالب موجود بالفعل" },
    ...
    alreadyScanned:   { fr: "Déjà scanné",                       en: "Already scanned",              ar: "تم المسح بالفعل" },
