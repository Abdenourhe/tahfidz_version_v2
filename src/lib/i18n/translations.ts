...
export const translations = {
  ...
  halaqa: {
    ...
    sessionNamePlaceholder: { fr: "Ex: Révision Sourate Al-Fatiha", en: "Ex: Al-Fatiha revision", ar: "مثال: مراجعة سورة الفاتحة" },
    ...
    audioOnlyDesc:    { fr: "Micro activé, caméra désactivée", en: "Mic on, camera off", ar: "الميكروفون مفعل، الكاميرا معطلة" },
    video:            { fr: "Audio + Vidéo",         en: "Audio + Video",         ar: "صوت + فيديو" },
    videoDesc:        { fr: "Micro et caméra activés", en: "Mic and camera on",   ar: "الميكروفون والكاميرا مفعلان" },
    ...
    sourahPlaceholder:{ fr: "Ex: Al-Fatiha",         en: "Ex: Al-Fatiha",         ar: "مثال: الفاتحة" },
    verses:           { fr: "Versets",               en: "Verses",                ar: "الآيات" },
    versesOptional:   { fr: "Versets (optionnel)",   en: "Verses (optional)",     ar: "الآيات (اختياري)" },
    versesPlaceholder:{ fr: "Ex: 1-7",               en: "Ex: 1-7",               ar: "مثال: 1-7" },
    participants:     { fr: "Élèves participants",   en: "Student participants",  ar: "الطلاب المشاركون" },
